        ...
        <div class="login-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-floating">
                    <input type="email" class="form-control" id="email" type="email" name="email" required placeholder="name@example.com" required>
                    <label for="email"><i class="fas fa-envelope me-2"></i>Email address</label>
                </div>
                <div class="form-floating">
                    <input type="password" class="form-control" id="password"  type="password" name="password"placeholder="Password" required>
